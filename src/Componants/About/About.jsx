      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-8 md:gap-20">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <p className="text-base sm:text-lg md:text-lg text-gray-400 mb-10 mt-8 leading-relaxed">
            I am a full-stack developer and I have experience building scalable
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1BlrawQxFZlxiwwetIxIq2c1acCh3CBWt/view?usp=sharing"
            target="_blank"
